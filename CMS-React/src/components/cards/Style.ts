...
export const OverviewCardMeshWrap = Styled.div`
...
export const InfoCardStyle = Styled.article<IInfoCard>`
    ${({ theme, type }) => `
...
export const NewsletterStyle = Styled.figure`
...
export const ProfileCardWrapper = Styled.figure`
  ${({ theme }) => `
    width: 100%;
    min-height: 360px;
    background-color: ${theme[theme.mainContent]['white-background']};        
...
export const BlogCardStyleWrap = Styled.figure`
    .ninjadash-blog{
        padding: 25px;
        border-radius: 10px;
