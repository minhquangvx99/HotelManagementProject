...
export const LayoutContainer = Styled.div`
    ...
    .ninjadash-header-content{
        ...
        .ninjadash-header-content__left{
            ...
            .link-transition {
                background: linear-gradient(to left, white 50%, rgb(243, 248, 255) 50%);
                background-size: 200% 100%;
                background-position: left bottom;
                transition: background-position 0.2s ease-out;
            }

            .link-transition.collapsed {
            ...
            .navbar-brand{
                ...
                button{
                    ...
                    background-color: ${({ theme }) => theme[theme.mainContent]['light-blue-background']};
            ...
            .ninjadash-logo{
                ...
                img{
                    max-width: ${({ theme }) => (theme.topMenu ? '140px' : '200px')};
                    margin-right: 20px;
                    width: 100%;
...
interface ISmallScreenAuthInfo {
  hide: boolean;
}

export const SmallScreenAuthInfo = Styled.div<ISmallScreenAuthInfo>`
    background-color: ${({ theme }) => theme[theme.mainContent]['white-background']};
    width: 100%;
    position: fixed;
...
interface ISmallScreenSearch {
  hide: boolean;
}

export const SmallScreenSearch = Styled.div<ISmallScreenSearch>`
    background-color: ${({ theme }) => theme[theme.mainContent]['white-background']};
    width: 100%;
    position: fixed;
...
export const TopMenuSearch = Styled.div`
    .top-right-wrap{
        position: relative;
