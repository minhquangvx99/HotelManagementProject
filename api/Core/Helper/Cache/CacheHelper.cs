...
namespace Core.Helper.Cache
{
    ...
    public class CacheHelper
    {
        ...
        {
            return string.Empty;
            //if (!string.IsNullOrEmpty(Configuration.GetConfigByKey("CacheFormatGenerateOutputParam")))
            //    return string.Format(Configuration.GetConfigByKey("CacheFormatGenerateOutputParam"), key, name);
            //else
